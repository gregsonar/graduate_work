...
class SubscriptionValidator(ISubscriptionValidator):
    ...
    ALLOWED_TRANSITIONS: Dict[SubscriptionStatus, Set[SubscriptionStatus]] = {
        ...
        SubscriptionStatus.ACTIVE: {SubscriptionStatus.SUSPENDED, SubscriptionStatus.CANCELED, SubscriptionStatus.EXPIRED},
    ...
    async def validate_subscription_period(self, plan_duration_days: int, start_date: datetime, end_date: datetime) -> bool:
