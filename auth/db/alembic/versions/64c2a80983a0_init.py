...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_access_logs_accessed_at", "access_logs", ["accessed_at"], unique=False
    )
    op.create_index(
        "ix_access_logs_ip_address", "access_logs", ["ip_address"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column("user_id", sa.UUID(), nullable=False),
        sa.Column(
            "provider", sa.Enum("VK", "YANDEX", name="socialprovider"), nullable=False
        ),
    ...
    op.create_index(
        ...
        "user_social_accounts",
        ["provider", "social_id", "created_at"],
        unique=True,
    )
    op.create_index(
        "ix_user_social_accounts_user_id",
        "user_social_accounts",
...
def downgrade() -> None:
    ...
    op.drop_index(
        "ix_user_social_accounts_provider_social_id", table_name="user_social_accounts"
    )
